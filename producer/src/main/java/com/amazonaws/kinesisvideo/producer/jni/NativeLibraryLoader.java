...
class NativeLibraryLoader {
    ...
    private boolean loadNativeLibraryDirect(final @Nonnull String libraryFullPath) {
        if (libraryFullPath != null && !libraryFullPath.isEmpty()) {
            try {
//                libraryFullPath = "/home/upen/projects/amazon-kinesis-video-streams-producer-sdk-cpp/kinesis-video-native-build/libKinesisVideoProducerJNI.so";
//                System.load("/home/upen/projects/amazon-kinesis-video-streams-producer-sdk-cpp/kinesis-video-native-build/libKinesisVideoProducerJNI.so");
